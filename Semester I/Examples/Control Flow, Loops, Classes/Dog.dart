class Dog {
  ...
  // constructor
  // Dog(String b, String color, String name, double weight) {
  //   this.breed = b;
  //   this.color = color;
  //   this.name = name;
  //   this.weight = weight;
  ...
  /*
   * Another way to declare constructor: declare named parameters so 
   * that the user knows exactly what to pass in
  */
